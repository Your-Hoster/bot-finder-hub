      ...
      >
        <Card>
          ...
          <CardContent className="prose dark:prose-invert">
            ...
            <p>{t('legal.information-collection-text')}</p>
            
            <h2>2. {t('legal.information-usage')}</h2>
            <p>{t('legal.information-usage-text')}</p>
            
            <h2>3. {t('legal.information-protection')}</h2>
            <p>{t('legal.information-protection-text')}</p>
            
            <h2>4. {t('legal.cookie-usage')}</h2>
            <p>{t('legal.cookie-usage-text')}</p>
            
            <h2>5. {t('legal.third-party-disclosure')}</h2>
            <p>{t('legal.third-party-disclosure-text')}</p>
            
            <h2>6. {t('legal.third-party-links')}</h2>
            <p>{t('legal.third-party-links-text')}</p>
            
            <h2>7. {t('legal.gdpr-compliance')}</h2>
            <p>{t('legal.gdpr-compliance-text')}</p>
            
            <h2>8. {t('legal.childrens-privacy')}</h2>
            <p>{t('legal.childrens-privacy-text')}</p>
            
            <h2>9. {t('legal.changes-to-policy')}</h2>
            <p>{t('legal.changes-to-policy-text')}</p>
            
            <h2>10. {t('legal.contact-us')}</h2>
            <p>{t('legal.contact-us-text')}</p>
          </CardContent>
        </Card>
      </motion.div>
    </div>
