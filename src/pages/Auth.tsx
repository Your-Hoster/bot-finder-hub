          ...
          <CardContent>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                <Button variant="outline" type="button" disabled={loading} onClick={signInWithDiscord}>
                  <svg className="h-5 w-5 mr-2" fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
